...
const AIAssistant: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-br from-black via-purple-950 to-black text-white overflow-hidden relative">
      ...
      <div className={`sticky top-0 z-10 transition-all duration-300 ${isHeaderVisible ? 'py-4 opacity-100' : 'py-1 opacity-0'}`}>
            ...
            >
              ...
              >
                ...
                {msg.images && msg.images.length > 0 && (
                  <div className={`mt-2 ${msg.text ? 'mt-3' : 'mt-0'} grid grid-cols-2 gap-2`}>
